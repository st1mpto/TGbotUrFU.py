...
def handle_main_menu(message):
    ...
    """
    user_data_entry = get_user_data(message.chat.id)
    # Добавляем кнопку "Помощь" в клавиатуру
    markup = create_keyboard(["🛠️ Изменить данные", "🔎 Поиск вакансий", "📈 Анализ вакансий", "🆘 Помощь"], include_main_menu=False)
...
popular_skills = [
    ...
    # Дополнительные обязанности из статьи
    "администрирование межсетевых экранов", "Cisco ASA", "Kerio Connect",
    "администрирование сервера антивирусной защиты", "мониторинг состояния клиентов",
    "удаление вирусов", "тонкая настройка защиты", "поиск уязвимостей",
    "устранение уязвимостей", "мониторинг обновлений", "настройка коммутационного оборудования",
    "написание скриптов", "управление инфраструктурой предоставления доступов",
    "анализ логов", "управление инцидентами безопасности", "анализ журналов событий",
    "сопровождение IT-инфраструктуры", "защита персональных данных",
    "мониторинг средств обеспечения ИБ", "администрирование средств защиты информации",
    "настройка межсетевого взаимодействия", "контроль нештатной активности",
    "анализ инцидентов ИБ", "проведение аудитов", "подготовка отчетов по ИБ",
    "тестирование на проникновение", "анализ исходных кодов", "выявление угроз OWASP TOP 10",
    "выработка компенсирующих мер", "ручное тестирование безопасности",
    "автоматизированное тестирование безопасности", "анализ защищенности",
    "расследование инцидентов безопасности", "сбор доказательной базы", "форензика",
    "разработка технической документации", "разработка аналитической документации",
    "участие в крупных проектах", "анализ защищенности SCADA", "анализ защищенности ERP",
    "анализ защищенности SS7", "анализ защищенности hardware",
]
